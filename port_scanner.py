import socket # Neccessary to have access to the socket library

user_ip = input("Enter your IP address:") # Prompt the user to enter their IP address
PORT_START = 1 # Starting port number to scan
PORT_END = 1024 # Ending port number to scan

for port in range(PORT_START, PORT_END + 1): # Loop through the range of ports from PORT_START to PORT_END
